...
dia = int(input("Qual dia da semana queres verificar se é útil ou não? Escolha do menu abaixo, utilizando o número correspondente (ex. prima 1 para segunda-feira):\n1 - Segunda-feira;\n2 - Terça-feira; \n3 - Quarta-feira; \n4 - Quinta-feira; \n5 - Sexta-feira; \n6 - Sábado; \n7 - Domingo;\n\nR: "))
